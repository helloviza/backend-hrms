...
router.get("/admin/pending", requireApprovalsAdminRead, async (req: AnyObj, res, next) => {
  try {
    ...
    if (req.workspaceObjectId) (baseFilter as any).workspaceId = req.workspaceObjectId;
...
router.get("/admin/approved", requireApprovalsAdminRead, async (req: AnyObj, res, next) => {
  try {
    ...
    if (req.workspaceObjectId) (filter as any).workspaceId = req.workspaceObjectId;
...
router.get("/admin/done", requireApprovalsAdminRead, async (req: AnyObj, res, next) => {
  try {
    ...
    if (req.workspaceObjectId) (doneFilter as any).workspaceId = req.workspaceObjectId;
...
router.get("/admin/rejected", requireApprovalsAdminRead, async (req: AnyObj, res, next) => {
  try {
    ...
    if (req.workspaceObjectId) (rejFilter as any).workspaceId = req.workspaceObjectId;
